// Frozen Phase 5 schema; do not regenerate from later ORM models.
export default {
  source_commit: '21e733fe779ab68822cbc5af08efa507350863a2',
  metadata: {
  ...
  objects: [
    ...
    },
    {
      ...
      sql: 'CREATE TABLE PlatformMetadata (platform_schema_version INTEGER NOT NULL PRIMARY KEY CHECK(platform_schema_version = 2), model_signature TEXT NOT NULL, schema_signature TEXT NOT NULL)',
    },
    {
      name: 'Repositories',
