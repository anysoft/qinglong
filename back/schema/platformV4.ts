// Frozen Phase 7 schema; never regenerate from later models.
export default {
  "source_commit": "33564c77af4996e9158dee0a0775a43d1d7e3d8f",
  "metadata": {
    "platform_schema_version": 4,
    "model_signature": "f87ccaa6e53e9a975ca25c8215dddd418900ac8c24370799f33cd3860efc973d",
    "schema_signature": "bed6850a372e4e208f56326de92dd784cb78ef009689519215706cb850a96f09"
  },
  "objects": [
    {
    ...
    },
    {
      ...
      "sql": "CREATE TABLE PlatformMetadata (platform_schema_version INTEGER NOT NULL PRIMARY KEY CHECK(platform_schema_version = 4), model_signature TEXT NOT NULL, schema_signature TEXT NOT NULL)"
    },
    {
