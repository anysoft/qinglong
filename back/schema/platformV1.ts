// Frozen platform v1 from commit 9a9ad297; never regenerate from v2 models.
export default {
  "source_commit": "9a9ad297",
  "metadata": {
    "platform_schema_version": 1,
    "model_signature": "ede94ec37ae87796c84a270a2a8da3ffd1991994cbc114e72abd18313c5f3add",
    "schema_signature": "643cd0c88b0525bddcdef7ce0cc384a655541db85be083e590a34b0ce125cf92"
  },
  "objects": [
    {
    ...
    },
    {
      ...
      "sql": "CREATE TABLE PlatformMetadata (platform_schema_version INTEGER NOT NULL PRIMARY KEY CHECK(platform_schema_version = 1), model_signature TEXT NOT NULL, schema_signature TEXT NOT NULL)"
    },
    {
      "name": "Repositories",
