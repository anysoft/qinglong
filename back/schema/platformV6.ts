// Frozen Phase 9 schema. Never regenerate from later models.
export default {
  source_commit: 'bf7f5ec5c1814b991c60571976b78d9db102b058',
  metadata: {
  ...
  objects: [
    ...
    },
    {
      ...
      sql: 'CREATE TABLE PlatformMetadata (platform_schema_version INTEGER NOT NULL PRIMARY KEY CHECK(platform_schema_version = 6), model_signature TEXT NOT NULL, schema_signature TEXT NOT NULL)',
    },
    {
