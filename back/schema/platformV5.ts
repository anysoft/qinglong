// Frozen Phase 8 schema. Never regenerate from later models.
export default {
  source_commit: '47294399de53dd857caa8caa936fc9d4dbab0586',
  metadata: {
  ...
  objects: [
    ...
    },
    {
      ...
      sql: 'CREATE TABLE PlatformMetadata (platform_schema_version INTEGER NOT NULL PRIMARY KEY CHECK(platform_schema_version = 5), model_signature TEXT NOT NULL, schema_signature TEXT NOT NULL)',
    },
    {
