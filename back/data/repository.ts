...
export interface Repository extends RepositoryIdentity {
  ...
  default_env_profile_id?: number | null;
...
export const RepositoryModel = sequelize.define<RepositoryInstance>(
  'Repository',
  {
    ...
    default_env_profile_id: { type: DataTypes.INTEGER, allowNull: true, references: { model: 'EnvironmentProfiles', key: 'id' }, onDelete: 'RESTRICT' },
