...
const RUNNER_NAMES = /^(?:QL_TASK_ENV_|PREV_|dir_|file_|cmd_|list_|task_shell_|script_params$|_task_exit_code$|which_program$|timeoutCmd$|ID$|SUB_ID$|task_before$|task_after$|work_dir$|real_time$|real_log_path$|no_tee$|log_path$|log_dir$|log_name$|envParam$|numParam$|UID$|EUID$|PPID$|BASHOPTS$|SHELLOPTS$|BASH_VERSINFO$|FUNCNAME$|PIPESTATUS$)/;
