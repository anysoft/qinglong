...
const variables={...snapshot.variables,QL_DIR:root,QL_DATA_DIR:process.env.QL_DATA_DIR,PATH:[path.resolve(__dirname,'../../node_modules/.bin'),process.env.PATH].filter(Boolean).join(path.delimiter)};
